...
export function displayRecordVanLoonstrook(w: LoonstrookRecord, basis?: SalarisRecord): SalarisDisplayRecord {
  ...
  return {
    ...
    generatedFromSchedule: basis?.generatedFromSchedule,
    totaalUren: basis?.totaalUren,
    contractUren: basis?.contractUren,
    contractUrenPerWeek: basis?.contractUrenPerWeek,
    extraUren: basis?.extraUren,
    ortUren: basis?.ortUren,
    ortUrenDetail: basis?.ortUrenDetail,
    salarisCalibratie: basis?.salarisCalibratie,
    bron:           "werkelijk",
    werkelijk:      w,
  };
}
