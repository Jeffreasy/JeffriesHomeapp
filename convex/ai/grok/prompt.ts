...
- Als de gebruiker LaventeCare leads/pipeline wil zien, een leadstatus wil wijzigen of een lead naar project wil zetten → gebruik eerst laventecareLeadsOpvragen voor exacte IDs, daarna laventecareLeadBijwerken of laventecareLeadNaarProject. Wijzigen/converteren loopt via server-side bevestiging.
...
- Als de gebruiker LaventeCare projecten/delivery wil zien of projectstatus/fase/deadline wil wijzigen → gebruik eerst laventecareProjectenOpvragen voor exacte IDs, daarna laventecareProjectBijwerken. Wijzigen loopt via server-side bevestiging.
