...
import {
  ...
  handleLaventeCareLeadBijwerken,
  handleLaventeCareLeadMaken,
  handleLaventeCareLeadNaarProject,
  handleLaventeCareLeadsOpvragen,
  handleLaventeCareProjectBijwerken,
  handleLaventeCareProjectMaken,
  handleLaventeCareProjectenOpvragen,
...
const TOOL_HANDLERS: Record<string, ToolHandler> = {
  ...
  laventecareLeadsOpvragen: handleLaventeCareLeadsOpvragen,
  laventecareLeadBijwerken: handleLaventeCareLeadBijwerken,
  laventecareLeadNaarProject: handleLaventeCareLeadNaarProject,
  laventecareProjectMaken: handleLaventeCareProjectMaken,
  laventecareProjectenOpvragen: handleLaventeCareProjectenOpvragen,
  laventecareProjectBijwerken: handleLaventeCareProjectBijwerken,
